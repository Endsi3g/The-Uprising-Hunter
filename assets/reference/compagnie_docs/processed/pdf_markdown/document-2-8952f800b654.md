...
- `page_count`: `6`
- `generated_at`: `2026-02-16T05:35:36.056606+00:00`
...
"Bonjour [Prénom], 
Ici Kael Belceus, Architecte @ Uprising Studio (message commercial). 
Je vous contacte sur la base d'un consentement implicite lié à notre connexion LinkedIn 
récente (demande acceptée le [date]). 
J'ai analysé l'infrastructure digitale de [Nom Entreprise] ce matin : votre site mobile (42/100) 
agit comme un frein à la conversion. Concrètement, il met ~4.5 secondes à charger sur 
iPhone, et une part importante des visiteurs quitte avant de voir votre offre. 
J'ai enregistré une courte vidéo technique (2 min) où je montre précisément les points qui 
bloquent et les correctifs possibles. 
Souhaitez-vous que je vous envoie le lien ? 
Si vous ne souhaitez plus recevoir de messages commerciaux de ma part, répondez STOP." 
3.2 Scénario B : L'Email "Sniper" (Si pas sur LinkedIn) 
Context : Via Apollo.io. Envoie à l'adresse pro perso, pas info@. 
Sujet : Audit mobile [Nom Entreprise] (message commercial) 
(Mobile) 
"Bonjour [Prénom],

## Page 4

Je suis Kael Belceus, Architecte @ Uprising Studio (message commercial). 
Je vous écris sur la base d'un consentement implicite (coordonnées professionnelles publiques 
et activité récente de [Nom Entreprise] dans notre secteur). 
...
Pour vous désinscrire des emails commerciaux, répondez STOP. 
Bien à vous, 
...
"[Prénom], 
Ici Kael Belceus, Architecte @ Uprising Studio (message commercial). 
Je me permets de remonter ce message suite à mon premier contact du [date], basé sur un 
consentement implicite (relation d'affaires potentielle / prise de contact récente). 
...
Si vous ne souhaitez plus de relances commerciales, répondez STOP et je vous retire." 
